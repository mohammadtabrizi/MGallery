...
@objc open class INSPhoto: NSObject, INSPhotoViewable {
    ...
    public init(image: UIImage?, thumbnailImage: UIImage?,attributedTitle: NSAttributedString) {
        self.image = image
        self.thumbnailImage = thumbnailImage
        self.isDeletable = false
    }
    
    public init(imageURL: URL?, thumbnailImageURL: URL?,attributedTitle: NSAttributedString) {
        self.imageURL = imageURL
        self.thumbnailImageURL = thumbnailImageURL
        self.isDeletable = false
    }
    
    public init (imageURL: URL?, thumbnailImage: UIImage?,attributedTitle: NSAttributedString) {
        self.imageURL = imageURL
        self.thumbnailImage = thumbnailImage
        self.isDeletable = false
